...
KonsumenDataViewer::KonsumenDataViewer(QWidget *parent) : DataViewer(parent)
{
    ...
    setFilterColumnNames({"k.customer_code", "k.nama_lengkap", "k.nomor_telp", "k.email"});
    ...
    connect(ui->dataView, &QTableView::customContextMenuRequested,
            this, &KonsumenDataViewer::on_dataView_customContextMenuRequested);
...
QAction *KonsumenDataViewer::addKonsumenAction()
{
    if (m_addKonsumenAction == nullptr) {
        ...
        connect(m_addKonsumenAction, &QAction::triggered,
                this, &KonsumenDataViewer::onAddKonsumenActionTriggered);
    }
